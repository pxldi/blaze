...
class HelloTriangleApplication {
    ...
    private:
        ...
        void drawFrame() {
            ...
            // only reset fence if there is work submitted to prevent deadlock
            ...
            currentFrame = (currentFrame + 1) % MAX_FRAMES_IN_FLIGHT; // loop back after MAX_FRAMES_IN_FLIGHT frames
        }
        ...
        void CreateGraphicsPipeline() {
            ...
            // TODO: check if both shaders were loaded correctly via buffer sizes == file sizes
            ...
            vertexInputInfo.pVertexBindingDescriptions = nullptr; // hardcoded for now in shader :-)
            vertexInputInfo.vertexAttributeDescriptionCount = 0;
            vertexInputInfo.pVertexAttributeDescriptions = nullptr; // hardcoded for now in shader :-)
            ...
            rasterizer.polygonMode = VK_POLYGON_MODE_FILL; // fill area of polygons with fragments
            ...
            VkPipelineMultisampleStateCreateInfo multisampling{}; // used to perform antialiasing for now disabled
            ...
            pipelineInfo.basePipelineHandle = VK_NULL_HANDLE; // ability to create new pipeline by creating from existing (not used right now)
            ...
            //TODO: rest of code
            // after pipeline creation we can destroy shader modules
